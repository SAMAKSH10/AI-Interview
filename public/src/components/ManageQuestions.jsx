    ...
    <section className="min-h-screen bg-gray-900 text-white p-8">
      ...
      {editingQuestion && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-40">
          <div className="bg-gray-800 p-6 rounded-lg w-full max-w-lg relative animate-slide-in">
            <button
              ...
              {newType === 'MCQ' && (
                <div>
                  ...
                  {newChoices.map((choice, index) => (
                    <input
                      key={index}
                      className="w-full p-3 bg-gray-700 text-white rounded-lg mb-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors duration-300"
                      value={choice}
                      onChange={(e) => {
